...
#define ALWAYS_COLLIDE( group, should ) \
	...
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_BOTS, ASW_COLLISION_GROUP_MINES, false );
	...
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_FLAMER_PELLETS, ASW_COLLISION_GROUP_MINES, false );
	...
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_EXTINGUISHER_PELLETS, ASW_COLLISION_GROUP_MINES, false );
	...
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_IGNORE_NPCS, ASW_COLLISION_GROUP_MINES, false );
	...
	SHOULD_COLLIDE( COLLISION_GROUP_DEBRIS_BLOCK_PROJECTILE, ASW_COLLISION_GROUP_MINES, true );
	...
	SHOULD_COLLIDE( COLLISION_GROUP_DEBRIS, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_WEAPON, ASW_COLLISION_GROUP_GRENADES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_WEAPON, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_PROJECTILE, ASW_COLLISION_GROUP_GRENADES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_PROJECTILE, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_GRENADES, ASW_COLLISION_GROUP_GRENADES, false );
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_GRENADES, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_MINES, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_PLAYER, ASW_COLLISION_GROUP_GRENADES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_PLAYER, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_GRENADES, ASW_COLLISION_GROUP_BOTS, false );
	SHOULD_COLLIDE( ASW_COLLISION_GROUP_BOTS, ASW_COLLISION_GROUP_MINES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_DOOR_BLOCKER, ASW_COLLISION_GROUP_GRENADES, false );
	SHOULD_COLLIDE( COLLISION_GROUP_DOOR_BLOCKER, ASW_COLLISION_GROUP_MINES, true );
